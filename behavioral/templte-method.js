// Template Method - поведенческий паттерн, определяющий базовые шаги исполнения алгоритма;
// выполнение каждого шага делегирует на соответствующие методы и подклассы.
