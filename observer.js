// Observer - поведенческий паттерн, создающий механизм подписки, позволяющий одним объектам 
// следить за действиями других объектов
...
autonews.setNews('Lada has become electrical')