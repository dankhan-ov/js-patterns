// Strategy - поведенческий паттерн, определяющий схожие алгоритмы и помещает в каждый отдельный класс
// после чего, между этими алгоритмами можно переключаться в ходе разработки
